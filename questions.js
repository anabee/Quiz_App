var questions = [
    ...
    {
        title: "The condition in an if/else is enclosed within ___________.",
    ...
    {
        title: "Where is the Javascript linked inside an HTML document or page?",
        choices: ["In the <fooer> section.", "In the <title> section.", "In the <body> and <head> section.", "In teh <meta> section."],
        answer: ["In the <body> and <head> section."]
    },
    {
